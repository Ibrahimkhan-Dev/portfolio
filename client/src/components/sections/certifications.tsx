...
const certifications = [
  ...
  },
  {
    ...
    skills: ["Machine Learning", "Statistics", "Data Viz"],
    type: "Data Science"
  }
];
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {certifications.map((cert, index) => (
            <motion.div
              ...
              whileHover={{ y: -10 }}
              className="bg-card border-2 border-white/5 hover:border-primary p-8 flex flex-col h-full relative group"
            >
              ...
              <div className="space-y-3 mb-8">
                {cert.skills.map((skill, i) => (
                  <div key={i} className="flex items-center gap-2 text-white/70 text-sm font-bold uppercase">
              ...
              <div className="flex items-center justify-between pt-6 border-t border-white/5">
                ...
                <a href="#" className="p-2 bg-white/5 hover:bg-primary hover:text-black transition-all">
