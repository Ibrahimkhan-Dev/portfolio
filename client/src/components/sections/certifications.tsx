            ...
            <Dialog key={cert.id ?? String(index)}>
              <DialogTrigger asChild>
                ...
                >
                  ...
                  <p className="text-primary font-bold uppercase text-xs mb-6 tracking-widest">
                    {cert.issuer ?? ""}
                  </p>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {(cert.skills ?? []).map((skill) => (
                        <div
                          key={skill}
                          className="flex items-center gap-3 text-lg font-medium text-white/80 bg-white/5 p-3"
                        >
